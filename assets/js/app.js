...
function updateScore(right) {
  if (right >= 27) {
    cupImage.setAttribute("src", "assets/images/gold.png");
    message.innerHTML = "Congrats!";
  } else if (right <= 26 && right > 20) {
    cupImage.setAttribute("src", "assets/images/silver.png");
    message.innerHTML = "Nice";
  } else if (right <= 19 && right >= 11) {
    cupImage.setAttribute("src", "assets/images/bronze.png");
    message.innerHTML = "Passable";
  } else if (right <= 10) {
    cupImage.setAttribute("src", "assets/images/emojy.png");
